...
//        left panel
        ...
        b1.setFont(new Font("Comfortaa",Font.PLAIN,15));
        ...
        b2.setFont(new Font("Comfortaa",Font.PLAIN,15));
        ...
        b3.setFont(new Font("Comfortaa",Font.PLAIN,15));
        ...
        b4.setFont(new Font("Comfortaa",Font.PLAIN,15));
        ...
        b5.setFont(new Font("Comfortaa",Font.PLAIN,15));
        ...
        b6.setFont(new Font("Comfortaa",Font.PLAIN,15));
        ...
        b7.setFont(new Font("Comfortaa",Font.PLAIN,15));
        ...
        b8.setFont(new Font("Comfortaa",Font.PLAIN,15));
        ...
        b9.setFont(new Font("Comfortaa",Font.PLAIN,15));
        ...
        b10.setFont(new Font("Comfortaa",Font.PLAIN,15));
        ...
        b11.setFont(new Font("Comfortaa",Font.PLAIN,15));
        ...
        b12.setFont(new Font("Comfortaa",Font.PLAIN,15));
        ...
        b13.setFont(new Font("Comfortaa",Font.PLAIN,15));
        ...
        b14.setFont(new Font("Comfortaa",Font.PLAIN,15));
        ...
        b15.setFont(new Font("Comfortaa",Font.PLAIN,15));
