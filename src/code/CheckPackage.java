...
public class CheckPackage extends JFrame{
    ...
    CheckPackage() {
        ...
        setVisible(true);
        String[] package1 = new String[]{"package1.jpg","BRONZE PACKAGE","6 days and 7 Nights", "Airport Assistance at Aiport", "Half Day City Tour", "Welcome drinks on Arrival", "Daily Buffet", "Full Day 3 Island Cruise", "English Speaking Guide", "BOOK NOW", "Summer Special", "Rs 12000 only"};
